...
def get_match_events(match_id):
    ...
    cursor.execute("""
        SELECT g.minute, 'goal' as type, p.full_name as player_name, c.name as club_name, NULL as card_type
        FROM goals g
        ...
        SELECT ca.minute, 'card' as type, p.full_name, c.name, ca.card_type
        FROM cards ca
